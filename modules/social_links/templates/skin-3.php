...
<ul class="list-inline no-style mb-0">
    ...
    <?php if ($skype_enabled) { ?>
        <li class="me-2 my-2"><div class="   rounded-circle square w-45px d-flex align-items-center justify-content-center"><a href="//join.skype.com/invite/<?php print $skype_url; ?>" target="_blank" class="  text-opacity-5 position-absolute">><i class="mdi mdi-skype mdi-24px"></i></a></li>
    <?php } ?>
