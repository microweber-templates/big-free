                ...
                <?php if (!isset($show_fields) or $show_fields == false or in_array('thumbnail', $show_fields)): ?>
                    <div class="mw-new-16-photo-animation">
                        <a href="<?php print $item['link'] ?>">
                            <img loading="lazy" src="<?php print thumbnail($item['image'], 1900, 1900); ?>"/>
                ...
                <div class="mw-new-16-blog-content">
                    ...
                    if ($categories) {
                        foreach ($categories as $category) { ?>
                            <a href="<?php print $item['link'] ?>" class="mw-new-16-category-tag"> <?php print $category['title']; ?>  </a>
                        <?php }
                    }
                    ?>

                    <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                        <a class="mw-new-16-blog-title" href="<?php print $item['link'] ?>" class=" "><?php print $item['title'] ?></a>
                    <?php endif; ?>
