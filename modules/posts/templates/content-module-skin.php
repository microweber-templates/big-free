                            ...
                            <a href="<?php print $item['link'] ?>">
                                <div class="img__wrap">
                                    <div class="img-as-background h-650">
                                        <img class="img_img" alt="image" src="<?php print thumbnail($item['image'], 800, 800); ?>" />
                                    </div>
                                    <div class="img__description_layer">
                                        <div class="row text-center align-self-center"></div>
                                        <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                                            <h2 class="img__description"> <small class="mb-2 d-block"><?php echo date('d M Y', strtotime($item['created_at'])); ?></small> <?php print $item['title'] ?></h2>
                                        <?php endif; ?>
