                ...
                <div class="h-100 d-flex flex-column post-19">
                    ...
                    <a href="<?php print $item['link'] ?>" class="   d-block">
                        <div class="img-as-background h-600">
                            <img loading="lazy" src="<?php print thumbnail($item['image'], 1900, 1900); ?>" style="position: relative !important; object-fit: cover;"/>
                        </div>
                    </a>
                    <?php endif; ?>
                    ...
                    <div class="pt-4 pb-3">
                        ...
                        <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                            <a href="<?php print $item['link'] ?>" class=" "><h6 class="text-start text-left font-weight-bold"><?php print $item['title'] ?></h6></a>
                        <?php endif; ?>
