                ...
                <div class="col-md-4 col-sm-10 col-12 mx-auto mb-4" itemscope itemtype="<?php print $schema_org_item_type_tag ?>">
                    <div class="mw-post-22-post-card">
                        <?php if (!isset($show_fields) or $show_fields == false or in_array('thumbnail', $show_fields)): ?>
                            <a class="mw-post-22-post-thumbnail-link" href="<?php print $item['link'] ?>">
                                <img class="attachment-full size-full" loading="lazy" src="<?php print thumbnail($item['image'], 1220, 1720); ?>"/>
                            </a>
                        <?php endif; ?>
                        ...
                        <div class="mw-post-22-post-text">
                            <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                                <h3 class="mw-post-22-post-title">
                                    <a href="<?php print $item['link'] ?>" class=" "><?php print $item['title'] ?></a>
                                </h3>
                            <?php endif; ?>
                            ...
                            <?php if (!isset($show_fields) or $show_fields == false or in_array('read_more', $show_fields)): ?>
                                <a href="<?php print $item['link'] ?>" class="mw-post-22-post-read-more" aria-label="Read more about <?php print $item['title'] ?>">View Partner »</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
