...
<section class="section mw-layout-dark-background py-0 d-flex align-items-center justify-content-center">
    ...
    <div class="mw-layout-container py-4 container mh-100vh d-flex align-items-center justify-content-center no-element edit no-select  safe-mode" field="layout-header-skin-1-<?php print $params['id'] ?>" rel="module">
