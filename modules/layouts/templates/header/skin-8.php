...
<section class="section py-0 d-flex align-items-center justify-content-center">
    ...
    <div class="mw-layout-container py-4 container mh-100vh d-flex align-items-center justify-content-center no-element edit no-select" field="layout-header-skin-8-<?php print $params['id'] ?>" rel="module">
