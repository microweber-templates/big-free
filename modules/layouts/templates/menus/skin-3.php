...
<section class="header-background px-0 mw-menu-skin-com" id="mw-header-background">
    ...
    <div class="container mw-menu-skin-com-container">
        <div class="row col-12 d-flex justify-content-between align-items-center order-1">
            ...
            <div class="col-auto order-lg-3 order-2 ms-lg-0 ms-auto edit" field="header_menu-<?php print $params['id']; ?>button-wrapper" rel="global" id="header_menu-<?php print $params['id']; ?>button-wrapper">
