            ...
            <?php $count = -1; foreach ($data as $item): $count++; ?>
                <div class="col-sm-6 col-md-4 col-lg-3 pb-3 px-2">
                    <a
                        ...
                        <div loading="lazy" class="background-image-holder mh-200" style="background-image: url('<?php print thumbnail ($item['filename'], 800, 800); ?>'); background-size: contain;"></div>
                    </a>
                </div>
            <?php endforeach; ?>
        <?php } ?>
